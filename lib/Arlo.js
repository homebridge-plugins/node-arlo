                        ...
                        if (reSubscription.test(msg.data.resource)) {
                            ...
                            switch(data.action) {
                                case "fullFrameSnapshotAvailable":
                                    ...
                                    break;
                                case "is":
                                    if (data.properties.motionDetected !== undefined) {
                                        camera.emit(Constants.EVENT_MOTION, data.properties.motionDetected);
                                        camera.emit(Constants.EVENT_UPDATE, data.properties);
                                    }
                                    else if (data.properties.activityState === 'fullFrameSnapshot') {
